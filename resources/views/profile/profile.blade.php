                    ...
                    <div class="card">
                        <div class="card-body pt-3">
                            ...
                            <ul class="nav nav-tabs nav-tabs-bordered">
                                ...
                                @can('is-admin')
                                    <li class="nav-item">
                                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-delete">حذف
                                            الحساب</button>
                                    </li>
                                @endcan
                                @can('is-admin')
                                    <li class="nav-item">
                                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#M_mode">الصيانة</button>
                                    </li>
                                @endcan
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade pt-3" id="M_mode">
                                    <section>
                                        <header>
                                            <h2 class="text-lg font-medium text-gray-900">
                                                وضع الصيانة
                                        ...
                                        <form method="post" action="{{ route('M_mode_Update') }}"
                                            class="mt-6 space-y-6">
                                            @csrf

                                            <div class="mb-3">
                                                <label for="massage" class="form-label">رسالة وضع الصيانة</label>
                                                <input id="massage" name="massage" type="text" class="form-control"
                                                    autocomplete="massage" value="{{ $M_mode_message }}">
                                                <x-input-error :messages="$errors->updatePassword->get('current_password')" class="mt-2" />
                                            </div>

                                            <div class="mb-3">
                                                <label class="switch">
                                                    <label> حالة الوضع</label>
                                                    <input class="form-check-input" type="checkbox" role="switch"
                                                        name="status" @if ($M_mode_status) checked @endif>
